 ...
 * Time: 9:51
 */
namespace EmpiricaPlatform\Plot\Indicators\MACD;

use EmpiricaPlatform\Plot\Collection\DataCollection;
...
class MACD extends DataCollection {
	...
	private function load() {
		...
		$macdArray=Trader::macd($array,$this->fastLength,$this->slowLength,$this->signalSmoothing);
